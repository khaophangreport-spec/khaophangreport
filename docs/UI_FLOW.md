...
ตรวจ Draft ใน Local Storage
  ├── มี Draft → กู้คืนข้อมูลที่ปลอดภัยแบบเงียบ
  └── ไม่มี Draft → แสดงฟอร์มหน้าเดียว
```
...
## 10. Flow P-03: เลือกหมวดปัญหา

### หน้าจอ

แสดงหมวดเป็น Dropdown ที่โหลดจาก `category.list`
...
เลือกหมวด
  ↓
บันทึกค่า categoryId ในฟอร์ม
  ↓
ตรวจพร้อมข้อมูลส่วนอื่นเมื่อกดส่ง
```
...
- ไม่มีปุ่มย้อนกลับในฟอร์ม
- หากมี Draft เดิม ต้องคงค่า

---

## 11. Flow P-04: กรอกรายละเอียด
...
- ข้อมูลต้องไม่หายเมื่อบันทึก draft

---

## 12. Flow P-05: ระบุสถานที่
...
## 15. Flow P-08: ความยินยอมและเงื่อนไข

### Consent Fields

1. ยืนยันว่าข้อมูลเป็นความจริงตามที่ทราบ
2. ยอมรับนโยบายความเป็นส่วนตัวและเงื่อนไขการใช้งาน
...
- Current navigation state ใช้ `aria-current` เมื่อมีหลายสถานะ
...
- CTA หน้าแรกเห็นชัด
- แจ้งปัญหาจากฟอร์มหน้าเดียวได้ครบถ้วน
- บันทึก draft แล้วข้อมูลที่ปลอดภัยไม่หาย
- Draft ทำงานตามข้อกำหนด
- ใช้ GPS หรือกรอกเองได้
- เพิ่มภาพได้สูงสุด 3 รูป
- แจ้งแบบ Anonymous ได้
- ระบบตรวจสอบข้อมูลทั้งฟอร์มก่อนส่ง
- ป้องกันกดส่งซ้ำ
- ได้ Tracking Code
- คัดลอกรหัสได้
...
3. หน้าแรก
4. Report Form แบบหน้าเดียว
5. Report Form Sections
6. Success Page
7. Track Search
